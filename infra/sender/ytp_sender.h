...
#ifndef WORKSPACE_TRADER_INFRA_YTPSENDER_H_
#define WORKSPACE_TRADER_INFRA_YTPSENDER_H_
#include <map>
#include <string>
...
struct YtpSender : SendApi {
 public:
  ...
  static std::map<int, YtpTraderInfo> ytp_trader_info_map;

 private:
  bool Init(void);
  static ytp::api::TraderApi *trader_api;
  static YtpTraderSpi *trader_spi;

  bool is_init_ = false;
};

#endif /* WORKSPACE_TRADER_INFRA_YTPSENDER_H_ */
