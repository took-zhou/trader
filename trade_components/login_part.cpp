...
namespace {
    ...
    vector<string> splitString(const string &str, const string &pattern)
    {
        ...
        if(str == "")
            return res;
        //鍦ㄥ瓧绗︿覆鏈熬涔熷姞鍏ュ垎闅旂锛屾柟渚挎埅鍙栨渶鍚庝竴娈��
        ...
        while(pos != strs.npos)
        {
            ...
            res.push_back(temp);
            //鍘绘帀宸插垎鍓茬殑瀛楃涓��鍦ㄥ墿涓嬬殑瀛楃涓蹭腑杩涜鍒嗗壊
...
bool LogInPart::logIn()
{
    ...
    INFO_LOG("鎺ュ彈鍒颁簡sem_login淇″彿, 鐧婚檰鎴愬姛锛�"); // @suppress("Invalid arguments")
...
bool LogInPart::logOut()
{
    ...
    INFO_LOG("鎺ュ彈鍒颁簡sem_logout淇″彿, lot out ok!");
    isLogIN = false;
    return true;
}
