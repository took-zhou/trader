...
#ifndef WORKSPACE_TRADER_DOMAIN_COMPONENTS_CTPTRADEAPI_CTPTRADEAPI_H_
#define WORKSPACE_TRADER_DOMAIN_COMPONENTS_CTPTRADEAPI_CTPTRADEAPI_H_
...
class CtpTraderBaseApi : public CThostFtdcTraderApi {
 public:
  CtpTraderBaseApi(){};
  CtpTraderBaseApi(CThostFtdcTraderApi *_m_pApi) : m_pApi(_m_pApi){};
  ~CtpTraderBaseApi(){};
 ...
 private:
  CThostFtdcTraderApi *m_pApi{nullptr};
