...
public:
    ...
    void ReqUserLogin(CThostFtdcReqUserLoginField& reqUserLogin, int  requestId);

	virtual void OnRspUserLogin(CThostFtdcRspUserLoginField *pRspUserLogin,
		CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);

    void ReqUserLogout(CThostFtdcUserLogoutField& logOutFIeld, int requestId);
	...
	///请求确认结算单
	virtual void ReqSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, int nRequestID);
	...
	void ReqOrderInsert_Ordinary_hai(CThostFtdcInputOrderField &ord, int nRequestID);
	...
	void ReqQryInstrument_hai(CThostFtdcQryInstrumentField& qryFields);
